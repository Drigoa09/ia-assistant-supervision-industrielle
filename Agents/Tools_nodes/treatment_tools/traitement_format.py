...
class fonctions_existantes(Enum):
    ...
    FILTRER = "filtrer", "Permet de filtrer des colonnes de DataFrame de sorte à ne les faire correspondre qu'à une valeur. Premier argument : Valeur correspondant à l'élément filtré.  2ème : Elément de dataFrame contenant l'élément filtré. 3ème arguments : Elément de dataFrame filtrée "
...
---------------------------------------------------------------------------------------------------------------------------------------
Pour filtrer : Permet de filtrer des colonnes de DataFrame de sorte à ne les faire correspondre qu'à une valeur.
---------------------------------------------------------------------------------------------------------------------------------------
